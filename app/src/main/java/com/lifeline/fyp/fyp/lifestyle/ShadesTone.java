...
public class ShadesTone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_shades_tone );
        ...
        ArrayAdapter<String> ageAdapter = new ArrayAdapter<String>(ShadesTone.this,
